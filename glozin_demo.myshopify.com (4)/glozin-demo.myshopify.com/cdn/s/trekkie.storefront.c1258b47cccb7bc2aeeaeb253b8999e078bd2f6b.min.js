! function() {
    var e = {
                    ...
                    const n = e.granular_consent,
                        ...
                        l = {
                            headers: {
                                ...
                                [n.isExtensionToken ? "Shopify-Storefront-Extension-Token" : "x-shopify-storefront-access-token"]: s
                            },
                            body: JSON.stringify(d(e)),
                            method: "POST"
                        };
                    return fetch(`https://${p}/api/unstable/graphql.json`, l).then((e => {
                ...
                var v = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        var t = e.eventName,
                            ...
                            c = {
                                schemaId: r || s,
                                payload: this.eventWithMetadata(t, a ? this.payloadWithCustomStorefrontMetadata(o) : o, n.s2sMetadata, i)
                            };
                        d.produce([c])
                        ...
                        return i(i({
                            ...
                            asset_version_id: "c1258b47cccb7bc2aeeaeb253b8999e078bd2f6b",
            ...
            6997: function(e, t, n) {
                ...
                }, t.determineCookieDomain = g, t.resetCookieDomain = function() {
                    o = void 0
                }
            },
            7662: function(e, t, n) {
                    ...
                    y = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            for (var a = {
                                ...
                                }, c = 0, u = this.integrations; c < u.length; c++) {
                                var d = u[c];
                                try {
