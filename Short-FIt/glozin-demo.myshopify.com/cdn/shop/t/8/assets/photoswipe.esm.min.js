...
const U = {
    ...
    $ = {
        ...
        html: {
            isCustomSVG: !0,
            inner: '<path d="M17.426 19.926a6 6 0 1 1 1.5-1.5L23 22.5 21.5 24l-4.074-4.074z" id="-zoom"/><path fill="currentColor" class="pswp__zoom-icn-bar-h" d="M11 16v-2h6v2z"/><path fill="currentColor" class="pswp__zoom-icn-bar-v" d="M13 12h2v6h-2z"/>',
...
class Y {
        ...
        if (this.slide && this.usePlaceholder())
            if (this.placeholder) {
                ...
                const t = this.instance.applyFilters(
                    "placeholderSrc", !(!this.data.msrc || !this.slide.isFirstSlide) && this.data.msrc,
                    this
                );
    ...
    setDisplayedSize(t, i) {
        if (
            this.element &&
            (this.placeholder && this.placeholder.setDisplayedSize(t, i), !this.instance.dispatch("contentResize", {
                    content: this,
                    width: t,
                    height: i,
                }).defaultPrevented &&
    ...
    Vt() {
        ...
        if (
            ((this.Zt = !this.kt && this.pswp.options.bgOpacity > 0.003),
                (this.Ft = this.kt ? t.element : t.bg), !this.Et)
        )
            return (
                (this.It = 0),
                (this.$t = !1),
...
class st extends class extends class {
    ...
    updateSize(t) {
        ...
        (i(this.si, s),
            ...
            this.mainScroll.resize(this.opener.isOpen), !this.hasMouse &&
    ...
    ii(t) {
        return (
            ...
            ((t.showHideAnimationType = "none"), (t.zoomAnimationDuration = 0)), { ...it,
                ...t
            }
        );
    }
