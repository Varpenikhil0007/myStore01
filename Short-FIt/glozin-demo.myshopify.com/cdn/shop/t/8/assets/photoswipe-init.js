...
class ZoomAction extends HTMLElement {
        ...
        this.querySelectorAll("a.media-gallery__image").forEach((a) => {
            ...
            a.addEventListener("click", (e) => {
                ...
                this.lightbox.on("uiRegister", () => {
                    ...
                    pswp ? .ui.registerElement({
                        ...
                        onInit: (el, pswp) => {
                            ...
                            // iconNext = document.createElement("svg");
                            // iconNext.setAttribute("width", 6);
                            // iconNext.setAttribute("height", 11);
                            // iconNext.setAttribute("fill", "none");
                            // useIconNext = document.createElement("use");
                            // useIconNext.setAttribute("href", "#icon-next");
                            // iconNext.appendChild(useIconNext);
              ...
              <use href="#icon-next"></use>
                            ...
                            // iconPrev = document.createElement("svg");
                            // iconPrev.setAttribute("width", 6);
                            // iconPrev.setAttribute("height", 11);
                            // iconPrev.setAttribute("fill", "none");
                            // useIconPrev = document.createElement("use");
                            // useIconPrev.setAttribute("href", "#icon-back");
                            // iconPrev.appendChild(useIconPrev);
    ...
    initDrift() {
        ...
        const paneContainer = this.closest(".sec__featured-product").querySelector(
            ".zoom-external-area"
        );
