...
(() => {
    ...
    n.n = t => {
        ...
        var P = n(850),
            A = n.n(P),
            D = {};
        D.styleTagTransform = S(), D.setAttributes = I(), D.insert = w().bind(null, "head"), D.domAPI = y(), D.insertStyleElement = k(), v()(A(), D), A() && A().locals && A().locals;
        ...
        function Dt(t, e, n) {
            ...
            return (r || !r && !n) && (("body" !== Ct(e) || At(s)) && (u = (i = e) !== vt(i) && yt(i) ? {
        ...
        function Rt(t) {
            return ["html", "body", "#document"].indexOf(Ct(t)) >= 0 ? t.ownerDocument.body : yt(t) && At(t) ? t : Rt(Tt(t))
        }
        ...
        function Xt(t, e) {
            ...
            var i = Rt(t),
                ...
                r = vt(i),
                a = o ? [r].concat(r.visualViewport || [], At(i) ? i : []) : i,
                s = e.concat(a);
        ...
        function Ft(t) {
            return yt(t) && "fixed" !== Pt(t).position ? t.offsetParent : null
        }

        function zt(t) {
            for (var e = vt(t), n = Ft(t); n && Mt(n) && "static" === Pt(n).position;) n = Ft(n);
            return n && ("html" === Ct(n) || "body" === Ct(n) && "static" === Pt(n).position) ? e : n || function(t) {
                var e = /firefox/i.test(Ot());
                if (/Trident/i.test(Ot()) && yt(t) && "fixed" === Pt(t).position) return null;
                var n = Tt(t);
        ...
        function le(t) {
            ...
            if (u) {
                var I = zt(n),
                    O = "clientHeight",
                    k = "clientWidth";
                I === vt(n) && "static" !== Pt(I = jt(n)).position && "absolute" === s && (O = "scrollHeight", k = "scrollWidth"), (o === Nt || (o === _t || o === Bt) && r === Ut) && (w = Vt, m -= (d && I === x && x.visualViewport ? x.visualViewport.height : I[O]) - i.height, m *= c ? 1 : -1), o !== _t && (o !== Nt && o !== Vt || r !== Ut) || (b = Bt, f -= (d && I === x && x.visualViewport ? x.visualViewport.width : I[k]) - i.width, f *= c ? 1 : -1)
            }
        ...
        function we(t, e, n) {
            return e === Zt ? be(function(t, e) {
                ...
                var e, n = jt(t),
                    ...
                    s = -i.scrollLeft + Lt(t),
                    c = -i.scrollTop;
                return "rtl" === Pt(o || n).direction && (s += wt(n.clientWidth, o ? o.clientWidth : 0) - r), {
                    width: r,
                    height: a,
                    x: s,
                    y: c
            ...
            var n = e,
                ...
                x = function(t, e, n, i) {
                    var o = "clippingParents" === e ? function(t) {
                            var e = Xt(Tt(t)),
                                n = ["absolute", "fixed"].indexOf(Pt(t).position) >= 0 && yt(t) ? zt(t) : t;
            ...
            fn: function(t) {
                ...
                if (!e.modifiersData[i]._skip) {
                    for (var o = n.mainAxis, r = void 0 === o || o, a = n.altAxis, s = void 0 === a || a, c = n.fallbackPlacements, u = n.padding, l = n.boundary, d = n.rootBoundary, h = n.altBoundary, f = n.flipVariations, p = void 0 === f || f, m = n.allowedAutoPlacements, v = e.options.placement, g = re(v), y = c || (g !== v && p ? function(t) {
                        ...
                        var Y = me(D),
                            T = [];
                        if (r && T.push(A[C] <= 0), s && T.push(A[D] <= 0, A[Y] <= 0), T.every((function(t) {
                                return t
                            }))) {
                            k = S, O = !1;
                            break
        ...
        var Ne = function() {
            function e(t, n, i) {
                ...
                })), this.isMagnifyOpen = !1, this.isDragged = !1, this.startPointerZoom = !1, this.zoomIntensity = 0, this.mouseTracked = !1, this.intialPositions = {
                    x: 0,
                    y: 0
            ...
            return n = e, i = [{
                ...
                value: function(t) {
                    if (this.imagesLoaded) {
                        ...
                        this.hideInitialIcons(), (this.autoplay || this.loopTimeoutId) && (this.stop(), this.autoplay = !1, this.isZoomReady = !0), this.intialPositions = {
                            ...
                            x: n,
                            y: i
                        }, this.isClicked = !0, this.isDragged = !1, this.hotspotsConfigs && Me(this.hotspotsConfigs, t, !0), e && (this.isClicked = !1), this.hotspotsConfigs && mt(this.container, this.hotspotsConfigs, this.activeImageX, this.activeImageY, this.movingDirection)
                    }
                }
            }, {
                key: "mouseUp",
                value: function() {
                    ...
                    this.imagesLoaded && this.isClicked && (this.movementStart = {
                        x: 0,
                        y: 0
                    }, this.isStartSpin = !1, this.isClicked = !1, this.bottomCircle && !this.mouseTracked && this.show360ViewCircleIcon(), this.hotspotsConfigs && Me(this.hotspotsConfigs), this.pointerZoom && !this.fullscreenView ? (setTimeout((function() {
                        t.isZoomReady = !0
                ...
                value: function(t, n) {
                    var i, o, r = this,
                        a = this.container,
                        s = d(a);
                    if (i = this, o = s, Object.keys(o).reduce((function(t, e) {
                            var n = i[e] !== o[e];
                        ...
                        return a.removeChild(this.innerBox), (a = a.cloneNode(!0)).className = a.className.replace(" initialized", ""), c.parentNode.replaceChild(a, c), n.splice(u, 1, new e(a))
                    }
                ...
                value: function() {
                    var t, e;
                    this.view360CircleIcon = (t = this.bottomCircleOffset, (e = new Image).src = "https://scaleflex.cloudimg.io/v7/plugins/js-cloudimage-360-view/assets/img/360.svg", e.style.bottom = "".concat(t, "%"), e.className = "cloudimage-360-view-360-circle", e), this.innerBox.appendChild(this.view360CircleIcon)
                }
            }, {
                ...
                value: function(t) {
                    var e, n, i = this,
                        ...
                        E = r.keysReverse,
                        S = r.bottomCircle,
                        C = r.bottomCircleOffset,
                        j = r.boxShadow,
                        L = r.autoplay,
                        P = r.autoplayBehavior,
                        A = r.playOnce,
                        D = r.speed,
                        Y = r.autoplayReverse,
                        T = r.disableDrag,
                    ...
                    this.innerBox = function(t) {
                        ...
                        }, this.srcYConfig = ze(ze({}, this.srcXConfig), {}, {
                            filename: f,
                            orientation: u,
                            imageList: v,
                            amount: this.amountY
                        });
                    var ot = R(this.srcXConfig),
                        rt = function(t, e, n) {
                        ...
                        at = function() {
                            if (q(i.srcXConfig, ot, rt.bind(i, c)), i.allowSpinY) {
                                var t = R(i.srcYConfig);
                                q(i.srcYConfig, t, rt.bind(i, u))
                            }
                        };
                    B ? tt(ot, this.srcXConfig, (function(t) {
                        i.innerBox.removeChild(t), at()
                    })) : at(), this.attachEvents(x, O, k)
                }
        ...
        window.CI360 = window.CI360 || {}, window.CI360.init = Be, window.CI360.destroy = function() {
            _e() || (window.CI360._viewers.forEach((function(t) {
                t.destroy()
            ...
            t ? window.CI360._viewers.filter((function(e) {
                return e.id === t
            }))[0].updateView(e, window.CI360._viewers) : window.CI360._viewers.forEach((function(t) {
            ...
            if (e.length && t) {
                ...
                n && window.CI360._viewers.push(new Ve(n))
            }
            ...
            i && window.CI360._viewers.push(new Ve(i, !1, e))
        }, window.CI360.notInitOnLoad || Be()
    })()
})();