    ...
    customElements.define(
        ...
        class PickupAvailability extends HTMLElement {
            ...
            renderPreview(sectionInnerHTML) {
                ...
                const button = this.querySelector("button");
                const overlay = document.querySelector(".pickup-availability-drawer").querySelector(".overlay");
                setTimeout(() => {
                    if (button) {
                    ...
                    if (overlay) {
                        overlay.addEventListener("click", (event) => {
                            event.preventDefault();
                            if (document.querySelector("pickup-availability-drawer").classList.contains("open")) {
                                document.querySelector("pickup-availability-drawer").hide();
                            }
                        });
                    }
